...
const meta = CATEGORY_META["immobilier"];
const baseUrl = process.env.NEXT_PUBLIC_BASE_URL || "https://prolocal-landes.fr";

export const metadata: Metadata = {
  title: `${meta.seoTitle} | Prolocal-Landes`,
  description: meta.subtitle,
  alternates: { canonical: `${baseUrl}/categories/immobilier` },
  openGraph: {
    title: `${meta.seoTitle} | Prolocal-Landes`,
    description: meta.subtitle,
    url: `${baseUrl}/categories/immobilier`,
    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: meta.category, item: `${baseUrl}/categories/immobilier` },
        ],
      },
      {
        "@type": "CollectionPage",

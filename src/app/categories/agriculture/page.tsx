    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: meta.category, item: `${baseUrl}/categories/agriculture` },
        ],
      },
      {
        "@type": "CollectionPage",

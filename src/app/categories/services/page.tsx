    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: meta.category, item: `${baseUrl}/categories/services` },
        ],
      },
      {
        "@type": "CollectionPage",

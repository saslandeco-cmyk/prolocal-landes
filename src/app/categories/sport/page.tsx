    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: meta.category, item: `${baseUrl}/categories/sport` },
        ],
      },
      {
        "@type": "CollectionPage",
